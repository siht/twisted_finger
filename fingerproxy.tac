# como correr?
# virtual env:
# sudo /your/home/miniconda3/envs/twisted/bin/python /your/home/miniconda3/envs/twisted/bin/twistd -ny fingerproxy.tac --pidfile=proxy.pid
# instalación default:
# sudo twistd -ny fingerproxy.tac --pidfile=proxy.pid
...
class FingerClient(protocol.Protocol):
    ...
    def connectionLost(self, reason):
        self.factory.gotData(b''.join(self.buf))
...
# asegurate que tengas corriendo finger.tac antes de correr este script
...
strports.service('tcp:7779', IFingerFactory(f)).setServiceParent(service.IServiceCollection(application))
